...
import { Skeleton, Card, CardBody, Progress, Snippet , Image ,Link } from '@nextui-org/react'
import React from 'react'


async function getNFTData(params:any) {

    const slug= params;
    console.log(params)
    const response= await fetch(`${baseUrl}/signleNFTPool`,{
        method:'POST',
        headers:{
...
const nftData:any =getNFTData(params.nftDetails);
...
<div><h1>nft data is : {nftData.Tiers}</h1></div>
