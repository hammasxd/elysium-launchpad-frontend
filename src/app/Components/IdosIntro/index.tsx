...
const IdoIntro = ({ apiUrl, apiUrlPaginated, IntroTitle, bgImageSrc }: { apiUrl: string, apiUrlPaginated: string, IntroTitle: string, bgImageSrc: string }) => {
        ...
        >
            ...
            <div className="flex  gap-10 z-40  mt-20 mx-auto h-auto items-center justify-center top-0 inset-x-0 mb-20 bg-transparent capitalize">
                {ShowCompleted.length > 0 ? (
                    ShowCompleted.map((list: any, index) => {
                        return (
                            <div>
                                <Card key={index} className=" pb-4 w-[350px] bg-transparent backdrop-brightness-125 ">
            ...
            {modalList && (
                                    <Modal
                                        ...
                                        className="  bg-primary bg-opacity-10 rounded-3xl p-10 pb-5 shadow-secondary-700  "
                                    >
                                        <ModalContent className="scrollbar-hide">
                                            {(onClose) => (
                                                <>
                                                <div className="flex flex-row justify-between align-middle">
                                                <ModalHeader className=" align-middle gap-10">
                                                        <Image
                                                ...
                                                <div className="links flex flex-col justify-center align-middle" ><div className="flex flex-row">   

                                                <a href={modalList.ProjectFB} target="_blank">
                <span>
                  <svg
              ...
              <a href={modalList.ProjectInsta} target="_blank">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    id="icon-instagram"
              ...
              <a href={modalList.ProjectYoutube} target="_blank">
                <Image src={youtube.src} style={{ width: 36, height: 36 }} alt="youtubelogo" />
              </a>

              <a href={modalList.ProjectTweeter} target="_blank">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    id="icon-twitter"
              ...
              <a href={modalList.ProjectDiscord} target="_blank">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    id="Component_19_1"
              ...
              <a href={modalList.ProjectMedium} target="_blank">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    id="Component_18_1"
              ...
              <a href={modalList.ProjectTelegram} target="_blank">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    id="Component_17_1"
                                                            ...
                                                            <div className="DetailsNft ">
                                                                <Card  className=" bg-transparent shadow-none ">
                                                                    ...
                                                                    <CardBody className=" overflow-visible py-0 w-full px-0 rounded-none">
                                                                        ...
                                                                        <Progress className=" mb-8 mt-2 h-3 rounded-lg" isStriped color="secondary" value={modalList.filledPercentage} aria-label="Loading..." />
                                                                        <div className="grid grid-cols-2 grid-rows-2 gap-x-20 mb-8" >
                                                                            <div className="col-span-1 flex-initial">
                                                                                <small className="w-full inline-flex text-tiny text-white">Tokens Offered</small>
                                                                                
                                                                                    <small className="font-bold">{modalList.totalSupply}
                                                                                    </small>
                                                                            ...
                                                                            <div className="col-span-1 flex-initial">
                                                                                <small className="w-full inline-flex text-tiny text-white">Tokens Remaining</small>
                                                                                    ...
                                                                                    <small className="font-bold"> {modalList.totalSupply - modalList.SetTotalTokenSold}
                                                                                    </small>
                                                                    ...
                                                                    <CardBody className=" overflow-visible py-0 w-full px-0 rounded-none">
                                                                        ...
                                                                        <div className="tokenMatrics flex flex-col gap-3">
                                                                            ...
                                                                            <div className="matricsDetail grid grid-cols-2 grid-rows-2 gap-5">
                                                                                <div className="1">
                                                                                <p>Name</p>
                                                                                <p>{modalList.TokenName}</p>
                                                                                </div>
                                                                                <div className="2">
                                                                                <p>Symbol</p>
                                                                                <p>{modalList.TokenSymbol}</p>
                                                                                </div>
                                                                                <div className="3">
                                                                                <p>Total Supply</p>
                                                                                <p>{modalList.totalSupply}</p>
                                                                                </div>
                                                                                <div className="4">
                                                                                <p>Decimals</p>
                                                                                <p>{modalList.TokenDecimal}</p>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            >{modalList.TokenAddress}</Snippet>
                                                                            </div>
